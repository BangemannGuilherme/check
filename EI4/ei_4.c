...
int main (int argc, char *argv[])
{
	...
	/*tenta iniciar o thread, indicando a função 'thread' e passando como argumento a string "Thread A"*/
	rstatus = pthread_create (&thread_idA, NULL, thread, (void*)("Thread A"));
	...
	/*tenta iniciar o thread, indicando novamente a função 'thread' e passando como argumento a string "Thread B"*/
	rstatus = pthread_create (&thread_idB, NULL, thread, (void*)("Thread B"));
